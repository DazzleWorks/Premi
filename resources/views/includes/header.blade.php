    ...
    <div class="inner">
        ...
        <ul class="nav masthead-nav">
            ...
            @else
                ...
                <li {!! Request::is('user/profile/'.Auth::user()->username)?'class="active"':'' !!}><a href="{!! url('user/profile/'.Auth::user()->username) !!}"><span class="glyphicon glyphicon-user"></span> Me</a></li>
